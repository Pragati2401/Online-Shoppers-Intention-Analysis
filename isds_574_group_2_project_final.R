...
online_Shopping = read.csv("C:Cleaned_online_shoppers_intention.csv", stringsAsFactors=F, head=T)
str(online_Shopping)
...
###bp .7confusion matrix and plot of tree
...
pred.class.rf = as.numeric(prob.rf > .7)
ytest = as.numeric(test$Revenue_True)  # Be careful! Check the variable type of your outcome
